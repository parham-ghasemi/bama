...
const popularCityCards = [
  { img: "/home/tehran.jpg", title: "اجاره ویلا در تهران" },
  { img: "/home/mashhad.jpg", title: "اجاره ویلا در مشهد" },
  { img: "/home/33pol.jpg", title: "اجاره ویلا در اصفهان" },
...
const northCityCards = [
  { img: "/home/noshahr.jpg", title: "اجاره ویلا در نوشهر" },
  { img: "/home/bandaranzali.jpg", title: "اجاره ویلا در بندر انزلی" },
  { img: "/home/rasht.jpg", title: "اجاره ویلا در رشت" },
  { img: "/home/sari.jpg", title: "اجاره ویلا در ساری" },
  { img: "/home/babol.jpg", title: "اجاره ویلا در بابل" },
  { img: "/home/amol.jpg", title: "اجاره ویلا در آمل" },
  { img: "/home/chalus.jpg", title: "اجاره ویلا در چالوس" },
  { img: "/home/ramsar.jpg", title: "اجاره ویلا در رامسر" },
];

const southCityCards = [
  { img: "/home/bandarabbas.webp", title: "اجاره ویلا در بندرعباس" },
  { img: "/home/bushehr.jpg", title: "اجاره ویلا در بوشهر" },
  { img: "/home/chabahar.jpg", title: "اجاره ویلا در چابهار" },
  { img: "/home/qeshm.jpg", title: "اجاره ویلا در قشم" },
  { img: "/home/kish.jpg", title: "اجاره ویلا در کیش" },
  { img: "/home/jiroft.jpg", title: "اجاره ویلا در جیرفت" }, // گزینه بکر جنوب
];
...
const Home = () => {
  ...
  const heroImages = ["/home/iran-hero.jpg", "/home/iran-hero2.jpg", "/home/iran-hero3.png"];
  ...
  return (
    <div className="w-screen min-h-screen relative ">
      <div className="absolute w-full h-[50vh] md:h-[720px] overflow-hidden z-0 hidden md:block">
        <Swiper
          modules={[Autoplay]}
          spaceBetween={0}
          slidesPerView={1}
      ...
      <div className="w-full max-w-7xl bg-white relative mx-auto mt-14 md:mt-96 rounded-xl min-h-52 p-4 md:p-6">
        ...
        <div className="mt-28 md:mt-7">
          <HomeRow
            noc={4}
            cards={popularCityCards}
            subtitle="اقامتگاه در شهرهای پرطرفدار با ما"
            title="اجاره ویلا در محبوب‌ترین شهرها"
            type="city"
          />
        </div>
        ...
        <div className="mt-16 md:mt-32">
          <HomeRow
            noc={5}
            cards={southCityCards}
            subtitle="تجربه اقامت در کنار مردم خونگرم جنوب با ما"
            title="بومگردی، ویلا و اقامتگاه در جنوب زیبا"
            type="house"
          />
        </div>
        ...
        <div className="mt-16 md:mt-32">
          <HomeRow
            noc={4}
            cards={northCityCards}
            subtitle="ویلا، سوئیت و کلبه در شمال زیبا"
            title="اجاره ویلا و اقامت تو شهرهای شمالی با ما"
            type="house"
          />
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-evenly gap-8" >
          {
            twoCards.map((card, index) => (
              <div key={index} className="mt-16 md:mt-32 flex flex-col gap-4 w-full md:w-xl rounded-xl overflow-hidden shadow-lg shadow-gray-400 hover:-translate-y-1 duration-300 transition-transform">
                <img src={card.img} alt={card.title} className="object-cover w-full h-[300px] md:h-[423px]" />
                <div className="p-4 md:p-7 pt-0 space-y-2">
                  <p className="text-xl md:text-2xl font-bold">
                    {card.title}
                  </p>
                  <p className="font-light text-base md:text-[16px] text-gray-500">
                    {card.desc}
                  </p>
                </div>
              </div>
        ...
        {/* grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-20 md:mt-36 gap-8 md:gap-14 w-[95%] mx-auto">
          {
        ...
        <div className="py-20 md:py-40 max-w-5xl mx-auto">
          <h2 className="font-semibold text-xl md:text-2xl mb-6">اجاره ویلا، سوئیت، آپارتمان و انواع اقامتگاه</h2>
          ...
          <h3 className="font-semibold text-lg md:text-xl mt-8 mb-4">مزایای اجاره ویلا</h3>
          ...
          <h3 className="font-semibold text-lg md:text-xl mt-8 mb-4">مقاصد محبوب برای اجاره ویلا</h3>
          <ul className="font-light text-sm list-disc list-inside space-y-2 text-gray-700">
          ...
          <h3 className="font-semibold text-lg md:text-xl mt-8 mb-4">انواع ویلا در جاباما</h3>
          <p className="font-light text-sm mt-4 text-pretty leading-relaxed">
          ...
          <h3 className="font-semibold text-lg md:text-xl mt-8 mb-4">رزرو آسان ویلا</h3>
          <p className="font-light text-sm mt-4 text-pretty leading-relaxed">
