  ...
  return (
    <div className="w-full border-t border-gray-300 bg-gray-200 pt-10">
      <div className="max-w-6xl mx-auto px-4 xl:px-0">
        <Link to={'/'} className="flex justify-center mb-12 md:mb-24">
          <img src="/logo.png" className="h-10 md:h-14" />
        </Link>

        <div className="flex flex-col items-center sm:flex-row justify-between flex-wrap gap-10">
          {footerLinks.map((item, index) => (
            <div className="flex flex-col items-center sm:items-start gap-1 min-w-[150px]" key={index}>
        ...
        <div className="flex flex-col md:flex-row justify-between text-sm mt-10 flex-wrap gap-4">
